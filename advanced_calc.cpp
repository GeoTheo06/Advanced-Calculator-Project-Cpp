...
int main() {
	...
	cout << endl << "Normal Calculator Symbols: + | - | * | / | ^ | v (v for roots)" << endl << endl << "The output will be saved to the clipboard, so if you want to use it as input later, just ctrl + v ;) - works only  for windows :(" << endl << endl << "If you want to use  trigonometric functions, write sin, cos or tan and the angle you want next to it. For example: sin30" << endl << endl<< "If you want to usequadratic equations, simply write the quadratic equation in this form: a*x^2+b*x+c (without spaces)" << endl << endl;
